...
@csrf
    <!-- BEGIN: Header-->
    <nav class="header-navbar navbar-expand-lg navbar navbar-with-menu navbar-fixed navbar-brand-center navbar-dark">
                ...
                <div class="navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="nav-item nav-search mr-2">
                            <a class="nav-link nav-link-search"  href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                <i class="ficon feather icon-power"></i>
                                <b style="position: relative; top: -3px;">salir <br> </b>
                            </a>
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item active">{{ Auth::user()->name }}, {{ Auth::user()->apellidos }}</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="profile-header mb-2">
                                <div class="relative">
                                    <div class="cover-container" style="height: 80px;background-color: #f4633a;">
                                    ...
                                    <div class="profile-img-container d-flex align-items-center justify-content-between">
                                        <img src="{{ Auth::user()->foto }}" class="fotoPerfil rounded-circle img-border box-shadow-1 animate__animated" alt="Card image" style="background: white;">
                                ...
                                <div class="d-flex justify-content-end align-items-center profile-header-nav">
                                    <nav class="navbar navbar-expand-sm w-100 pr-0">
                                        ...
                                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                            <ul class="navbar-nav justify-content-around w-75 ml-sm-auto menuOpciones">
                                                @can('per-prueba')
                                                <li class="nav-item px-sm-0 ulLi <?php if (strpos($tecto, "perfil") !== false) {echo 'ulLiActive';} else {echo '';} ?>">
                                                    <a href="{{ url('/perfil') }}" class="nav-link font-small-3">Todo</a>
                                                </li>
                                                @endcan
                                                <li class="nav-item px-sm-0 ulLi">
                                                    <a href="#" class="nav-link font-small-3">Biblioteca</a>
                                                </li>
                                                <li class="nav-item px-sm-0 ulLi">
                                                    <a href="#" class="nav-link font-small-3">Examenes</a>
                                                </li>
                                                <li class="nav-item px-sm-0 ulLi">
                                                    <a href="#" class="nav-link font-small-3">Tareas</a>
                                                </li>
                                                <li class="nav-item px-sm-0 ulLi <?php if (strpos($tecto, "institucion") !== false) {echo 'ulLiActive';} else {echo '';} ?>">
                                                    <a href="{{ url('/institucion') }}" class="nav-link font-small-3">Institución</a>
                                                </li>
                                                <li class="nav-item px-sm-0 ulLi <?php if (strpos($tecto, "usuarios") !== false) {echo 'ulLiActive';} else {echo '';} ?>">
                                                    <a href="{{ url('/usuarios') }}" class="nav-link font-small-3">Usuarios</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </nav>
    ...
    <script>
        $(document).ready(function() {
            setInterval(function() {
                $('.emoSinData').toggleClass('animate__heartBeat');
            }, 1000);

            setInterval(function() {
                $('.fotoPerfil').toggleClass('animate__bounce');
            }, 3000);
        });
    </script>
    @yield('jsContent')
